...
#
# File Description:
# Setup of simulation data environment 4
...
E <- c(rep(12000, I))   # Effective exposure rates for each quarter
lambda <- c(rep(0.03, I)) # Expected claim frequencies per quarter
...
# Specify the Weibull parameters (in this case using original, variable mean,
# [ADD DESCRIPTION OF DISTRIBUTION])
...
# Specify the Weibull parameters (in this case using original distribution
# settings, [ADD DESCRIPTION OF DISTRIBUTION])
...
# Set to have the default superimposed inflation
